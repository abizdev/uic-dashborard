<template>
  <div class="lists pb-20">
    <Banner activeItem="students" @open-modal="toggleModalOpen"  />
    <div class="lists-content container">
      <ListHeading :listHeading="listHeading" />
      <List listType="student" />
      <ListBottom listType="student" />
    </div>
  </div>
  
  <Modal title="Filter" :class="{ active: isOpenModal }" @close-modal="toggleModalOpen">
    <FormOptions title="Talabalik turi" :formOptions="formOptions" />
    <FormOptions title="OTM" :formOptions="formOptionsOtm" />
...
const formOptionsOtm: string[] = ['Bakalavr', 'Magistratura', 'Asperantura', 'Doktorantura',]
